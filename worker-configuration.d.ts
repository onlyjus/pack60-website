/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 4718db2c059cbd66ca4678e6e2fe20db)
// Runtime types generated with workerd@1.20260815.1 2026-08-20 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	CF_ACCESS_TEAM_DOMAIN: "rough-brook-dfe1.cloudflareaccess.com";
	CF_ACCESS_AUD: "a02013dffd75af36ee66f5cc05b1ebb8e25eecbc478c81f60389c5d8b7a2f245";
	ENVIRONMENT: string;
	LOCAL_AUTH_BYPASS: string;
	LOCAL_AUTH_EMAIL: string;
	BOOTSTRAP_ADMIN_EMAIL: string;
	MEMBER_APP_ORIGIN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD" | "ENVIRONMENT" | "LOCAL_AUTH_BYPASS" | "LOCAL_AUTH_EMAIL" | "BOOTSTRAP_ADMIN_EMAIL" | "MEMBER_APP_ORIGIN">> {}
}
